...

{
  ...
  sops = {
    ...
    age = {
      ...
      sops.age.keyFile = "/var/lib/sops-nix/key.txt"; # no need to persist this, it gets automatically generated by option below
      # master age key stored in keepass can also be used instead of host's ssh key
    ...
    secrets = {
      ...
      users-s = {
        neededForUsers = true;
        # owner = "s"; # owners can't be set for neededForUsers passwords
      };
    };
  };
  ...
  users.users.s = {
    home = "/home/s";
    isNormalUser = true;
    hashedPasswordFile = config.sops.secrets.users-s.path;
    shell = pkgs.nushell;
    extraGroups = [
      "wheel"
      "networkmanager"
  ...
  # add directories here to set permissions correctly for parent directories being created by mounts
